...
export default function CharacterModel(props) {
  const { nodes, materials } = useGLTF('/models/ghost_w_tophat-transformed.glb')
  return (
    <group {...props} dispose={null}>
      <group scale={0.0034} position={[0, -0.55, 0]}>
        <group position={[0, 155.777, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh castShadow receiveShadow  material={materials.Eyes} />
          <mesh castShadow receiveShadow  material={materials.Ghost_White} />
        </group>
        <mesh
          castShadow
          receiveShadow
...
useGLTF.preload('/models/ghost_w_tophat-transformed.glb')